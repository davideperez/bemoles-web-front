      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <source
                srcSet="/images/responsive/04_estudio/sala1.webp"
                media="(max-width: 480px)"
              />
              <Image
                src={"/images/04_estudio/sala1.webp"}
                alt={"Sum-arte"}
                objectFit={"cover"}
            ...
            >
              <source
                srcSet="/images/responsive/04_estudio/sala2.webp"
                media="(max-width: 480px)"
              />
              <Image
                src={"/images/04_estudio/sala2.webp"}
                alt={"Sum-arte"}
                objectFit={"cover"}
                border={{base:"5px solid #FFF", sm:"10px solid #FFF"}}
              />
          ...
          >
            ...
            >
              <source
                srcSet="/images/responsive/04_estudio/sala3.webp"
                media="(max-width: 480px)"
              />
              <Image
                src={"/images/04_estudio/sala3.webp"}
                alt={"Sum-arte"}
                objectFit={"cover"}
                border={{base:"5px solid #FFF", sm:"10px solid #FFF"}}
              />
            ...
            >
              <source
                srcSet="/images/responsive/04_estudio/sala4.webp"
                media="(max-width: 480px)"
              />
              <Image
                src={"/images//04_estudio/sala4.webp"}
                alt={"Sum-arte"}
                objectFit={"cover"}
                border={{base:"5px solid #FFF", sm:"10px solid #FFF"}}
              />
