...
const ManualPaymentModal: FC<Props> = ({ reserveId, isDisabled }) => {
...
/*           const { data: result } = await reserveService.getReservePayments(
  ...
  return (
    <>
      <Tooltip label="Realizar Pago Manual">
        <Button onClick={onOpen} size="md" bg="transparent" p={0} isDisabled={isDisabled}>
          <RiMoneyDollarBoxLine  color="#9D6E33" size={22} />
        </Button>
      </Tooltip>
