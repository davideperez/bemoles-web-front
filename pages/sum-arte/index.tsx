      ...
      >
        ...
        >
          <Stack position="relative" h={{ base: "580px", lg: "1100px" }}>
            <Flex as="picture">
              <source
                srcSet="/images/responsive/sum-arte-2.png"
            ...
            <Flex as="picture">
              <source
                srcSet="/images/responsive/sum-arte-3.png"
                media="(max-width: 480px)"
              />
              <Image
            ...
            <Flex as="picture">
              <source
                srcSet="/images/responsive/sum-arte-1.png"
                media="(max-width: 480px)"
              />
              <Image
            ...
            <Flex as="picture">
              <source
                srcSet="/images/responsive/sum-arte-4.png"
                media="(max-width: 480px)"
              />
              <Image
          ...
          <Stack spacing="40px" flex={1} maxW="403px" pt="3rem">
            <Stack spacing="16px" flex={1}>
              ...
              >
                ...
                literarias, seminarios, trabajos en grupo, proyección de Cine y
                encuentros en general. <br /> <br /> Montado con sonido
                profesional, video, iluminación variable, climatización y
                sanitarios. <b>Capacidad para 100 personas</b>, baños para
                discapacitados.
              </Text>
            </Stack>
            <Stack spacing="16px" flex={1}>
              ...
              <Text
                ...
                maxW="590px"
              >
                Los Bemoles cuenta con las instalaciones necesarias para prestar
                el servicio de despacho de comidas sencillas (pizzas, empanadas,
                etc) y de bebidas, estando inscripto en el registro
                correspondiente REBA.
              </Text>
            </Stack>
          </Stack>
        </Flex>
