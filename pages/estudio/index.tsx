          ...
          <Stack spacing="40px" flex={1} maxW="403px" pt="3rem">
            <Stack spacing="16px" flex={1}>
              ...
              <Text
                ...
                maxW="590px"
              >
                Amplia sala con estrictas características constructivas de
                acuerdo a lo indicado para el fin específico:{" "}
                ...
                <UnorderedList px="0.5rem">
                  ...
                  <ListItem>
                    Consola Digital Allen & Heath + Logic Pro.
                  </ListItem>
                  <ListItem>
                    Micrófonos Rode, Shure, Audio Technica, Sennheiser, AKG.
                  </ListItem>
                </UnorderedList>{" "}
              </Text>
            </Stack>
            <Stack spacing="16px" flex={1}>
              ...
              >
                ...
                interruptores térmicos y disyuntores, matafuegos y área
                protegida (médica).
              </Text>
            </Stack>
          </Stack>
